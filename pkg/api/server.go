...
func NewServerHTTP(userHandler *handler.UserHandler,
	...
	paymentHanlder *handler.PaymentHandler) *ServerHTTP {
	...
	// set up routes
	routes.UserRoutes(engine.Group("/"), userHandler, productHandler, cartHandler, orderHandler, otpHandler, paymentHanlder)
